export const plotStats_v2 = {
  ...
  Overall: {
    avg_tot: [
      [["AVG_PTS"], ["DOWN_AVG"], ["STD_AVG"], ["TOT"], ["UP_AVG"]],
    ...
    plus_minus: [
      [["AVG_PLUS_MINUS"], ["DOWN_PLUS_MINUS"], ["STD_PLUS_MINUS"], ["UP_PLUS_MINUS"]],
  ...
  Shots: {
    field_goals: [
      [
        ["AVG_FGM", "AVG_FGA", "DOWN_FGA", "DOWN_FGM","UP_FGA", "UP_FGM"],
    ...
    free_throws: [
      [
        ["AVG_FTM", "AVG_FTA", "DOWN_FTM", "DOWN_FTA","UP_FGA", "UP_FGM"],
        ["FT_PCT", "SORT_FT_PCT"],
      ],
      [
        ["FTM", "FTA"],
