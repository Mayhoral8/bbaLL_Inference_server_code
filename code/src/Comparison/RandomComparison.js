  ...
  return (
    <RandomPlayerContiner>
      <div
        ...
        onClick={() => setPlayer(props.one, props.two)}
      >
        <div className="continer">
          <div className="img-container-side">
            <GetPlayerImage
              playerName={props.one.replace(" ", "_").replace(".", ",")}
              isTeam={props.team}
            />
          </div>
        ...
        <div className="continer">
          <div className="img-container-side">
            <GetPlayerImage
              playerName={props.two.replace(" ", "_").replace(".", ",")}
              isTeam={props.team}
            />
          </div>
      ...
      >
        <div className="continer">
          <div className="img-container-side">
            <GetPlayerImage
              playerName={props.three.replace(" ", "_").replace(".", ",")}
              isTeam={props.team}
            />
          </div>
        ...
        <div className="continer">
          <div className="img-container-side">
            <GetPlayerImage
              playerName={props.four.replace(" ", "_").replace(".", ",")}
              isTeam={props.team}
            />
          </div>
      ...
      <div
        className="comparsion"
        onClick={() => setPlayer(props.five, props.six)}
      >
        <div className="continer">
          <div className="img-container-side">
            <GetPlayerImage
              playerName={props.five.replace(" ", "_").replace(".", ",")}
              isTeam={props.team}
            />
          </div>
      ...
      >
        <div className="continer">
          <div className="img-container-side">
            <GetPlayerImage
              playerName={props.seven.replace(" ", "_").replace(".", ",")}
              isTeam={props.team}
            />
          </div>
        ...
        <div className="continer">
          <div className="img-container-side">
            <GetPlayerImage
              playerName={props.eight.replace(" ", "_").replace(".", ",")}
              isTeam={props.team}
            />
          </div>
      ...
      >
        <div className="continer">
          <div className="img-container-side">
            <GetPlayerImage
              playerName={props.nine.replace(" ", "_").replace(".", ",")}
              isTeam={props.team}
            />
          </div>
        ...
        <div className="continer">
          <div className="img-container-side">
            <GetPlayerImage
              playerName={props.ten.replace(" ", "_").replace(".", ",")}
              isTeam={props.team}
            />
          </div>
